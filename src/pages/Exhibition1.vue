<template>
    <body>
    <div>
        <div style="height: 30px;"><el-button style="position: absolute; top: 30px; left: 100px;" @click="toExhibition4" type="primary" icon="el-icon-arrow-left">树纹展馆</el-button></div>
        <div style="height: 30px;"><el-button style="position: absolute; top: 30px; right: 100px;" @click="toExhibition3" type="primary" icon="el-icon-arrow-right">回纹展馆</el-button></div>
        <div class="main">
