<template>
    <body>
    <div>
        <div style="height: 30px;"><el-button style="position: absolute; top: 30px; left: 100px;" @click="toExhibition2" type="primary" icon="el-icon-arrow-left">八角星纹展馆</el-button></div>
        <div style="height: 30px;"><el-button style="position: absolute; top: 30px; right: 100px;" @click="toExhibition1" type="primary" icon="el-icon-arrow-right">卷草纹展馆</el-button></div>
        <div class="main">
